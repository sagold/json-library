...
function getRelationshipObject(defRelation, data) {
	if (defRelation.valid != null && defRelation.type) {
		return defRelation;
	}
	...
	var r = {
		// if models are found
		"valid": validate(defRelation, data, true),
	...
	// create pivot table
	if (defRelation.through && r.pivot == null) {
		r.pivot = {};
		pointer.set(data, defRelation.through, r.pivot);
	}
